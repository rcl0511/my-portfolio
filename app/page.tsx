    ...
    <main className="min-h-screen bg-white text-slate-900 selection:bg-emerald-100 font-sans leading-relaxed">
        ...
        <div className="z-10 max-w-5xl">
          ...
          >
            <p className="text-xl md:text-2xl text-slate-600 font-light leading-relaxed">
              "만들고 끝내는 것이 아니라, <br />
              <span className="text-slate-900 font-semibold underline decoration-emerald-400 decoration-4 underline-offset-4 uppercase">
                실제 문제 해결 → 검증 → 확장
              </span>
          ...
          <div className="flex flex-wrap gap-4 mt-12">
            <a
              href="#projects"
              className="group flex items-center gap-2 px-8 py-4 bg-slate-900 hover:bg-emerald-600 text-white font-bold transition-all text-xs tracking-widest rounded-full shadow-lg shadow-slate-200"
            >
              VIEW PROJECTS{" "}
              <ArrowRight
                size={16}
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-20">
            ...
            <div className="lg:w-1/3 space-y-16">
              <div>
                <h2 className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em] mb-10">
                  Identity
                </h2>
                  ...
                  <div className="flex flex-col sm:flex-row lg:flex-col xl:flex-row gap-8 xl:gap-10">
                    <div className="group">
                      ...
                      <a
                        ...
                        className="text-sm font-bold text-slate-900 border-b border-slate-200 pb-1 hover:border-emerald-500 transition-all"
                      >
                        rcl0511@naver.com
                      </a>
                    </div>
            ...
            <div className="lg:w-2/3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <SkillCard
                  title="Embedded / IoT"
                  icon={<Cpu size={24} />}
                  skills={["Arduino", "ESP32", "BLE GATT", "Wi-Fi AP"]}
                ...
                <SkillCard
                  ...
                  skills={["MongoDB", "Git", "Figma", "Vercel", "Netlify"]}
      ...
      <section id="projects" className="py-32 px-6 md:px-20 bg-slate-50">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-sm font-bold text-emerald-600 uppercase tracking-[0.4em] mb-24">
            Selected Projects
          </h2>
      ...
      >
        ...
        <div className="flex justify-center gap-8 mb-16">
          <a
            href="mailto:rcl0511@naver.com"
            className="p-4 rounded-full bg-slate-100 hover:bg-emerald-500 hover:text-white transition-all duration-500 shadow-sm"
          >
            <Mail size={24} />
          </a>
  ...
  return (
    <div
      className={[
        ...
        isPrimary
          ? "bg-white border border-emerald-200 shadow-2xl shadow-emerald-100/60 hover:shadow-emerald-200/60"
          ...
          <div
            className={[
              ...
              isPrimary
                ...
                : "bg-white text-slate-400 group-hover:text-emerald-500",
            ].join(" ")}
          >
            {icon}
          </div>
